...
```powershell
uv run python gui_main.py --config C:\path\to\config.json
```
...
```powershell
$process = Start-Process -FilePath .\dist\Auto-Connect-CampusNet-GUI.exe `
