# WentUrc_ASCII_Art_Tool/image_processing/converter_png.py

import os
from PIL import Image, ImageDraw, ImageFont
from WentUrc_ASCII_Art_Tool.utils.file_utils import get_next_available_filename
...
def save_ascii_to_png(ascii_art, corrected_width, corrected_height, output_directory=None, font_path=None):
    """
    ...
    # 保存图片
    try:
        output_path = get_next_available_filename(output_directory, base_name="ascii_art", extension=".png")
...
def convert_and_save(image_path, target_width=300):
    ...
    """
    ascii_art, corrected_width, corrected_height = convert_image_to_ascii(image_path, target_width=target_width)
    if ascii_art:
